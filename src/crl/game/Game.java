...
public class Game implements CommandListener, PlayerEventListener, java.io.Serializable{
    ...
    private String [] DEATHMESSAGES = new String[]{
		"You have perished on the mountain Drash",
		"Suddenly, all goes dark. This is Over.",
		"Game Over",
		"Better luck next time, Stranger from another world"
    };
