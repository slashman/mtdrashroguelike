...
public class GFXIconEffect extends GFXEffect{
	...
	public void drawEffect(GFXUserInterface ui, SwingSystemInterface si){
		...
		if (ui.insideViewPort(center))
			si.drawImage(center.x*GFXUserInterface.TILESIZE+GFXUserInterface.UPLEFTBORDER, center.y*GFXUserInterface.TILESIZE+GFXUserInterface.UPLEFTBORDER-4*height, tile);
		si.refresh();
		animationPause();
		si.restore();
	}
