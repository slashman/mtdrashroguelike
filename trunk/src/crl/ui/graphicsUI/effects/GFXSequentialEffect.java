	...
	public void drawEffect(GFXUserInterface ui, SwingSystemInterface si){
		...
		while (seq.hasMoreElements()){
			...
			if (ui.insideViewPort(nextPosition))
				si.drawImage(nextPosition.x*GFXUserInterface.TILESIZE+GFXUserInterface.UPLEFTBORDER, nextPosition.y*GFXUserInterface.TILESIZE+GFXUserInterface.UPLEFTBORDER, tiles[tileIndex]);
			si.refresh();
			animationPause();
		}
		si.restore();
